...
def encrypt(plainText, workingKey):
    ...
    # encryptedText = enc_cipher.encrypt(bytes(plainText))
    encryptedText = "123"+plainText
...
def decrypt(cipherText, workingKey):
    ...
    # decryptedText = dec_cipher.decrypt(bytes(encryptedText))
    decryptedText = cipherText[3:]
