...
async def webprint(request: Request):
    return templates.TemplateResponse("dataFrom.htm", {"request":request})

# @ccav_router.post('/ccavResponseHandler')
# async def ccavResponseHandler(request: Request):
#     plainText = res(request.form().get('encResp'))
#     print("res: ", plainText)
#     return plainText

@ccav_router.post('/ccavRequestHandler', response_class=HTMLResponse)
async def login(request: Request):
    ...
    return templates.TemplateResponse('merPage.htm', {"request":request, "mid":p_merchant_id,"encReq":"encryption", "xscode":accessCode})
